...
const EncryptButton = () => {
  const intervalRef = useRef<number | null>(null); // Specify the type of intervalRef
  ...
  const scramble = () => {
    ...
    intervalRef.current = window.setInterval(() => { // Use window.setInterval for type compatibility
